...
const App = () => {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      // Adjusted target to Monday, January 12th, 2026
      const targetDate = new Date('2026-01-12T23:59:59').getTime();
  ...
  const lanes: PricingLane[] = [
    {
      ...
      terms: 'Permanent stake in the NWI ecosystem. Valued at $47/mo, currently locked at $9.99 for the stewardship window.',
      price: '$9.99',
      priceNote: 'FOR STEWARDSHIP WINDOW',
    ...
    <div className="relative min-h-screen bg-[#0B162A]">
        ...
        <div className="relative z-10 text-center px-8 max-w-5xl">
          ...
          <div className="flex flex-col items-center gap-12">
            ...
            <div className="flex flex-col items-center">
               <span className="text-[9px] uppercase tracking-[0.6em] text-[#C83803] font-black italic opacity-60">Window Closes Mon Jan 12</span>
          ...
          <div className="grid lg:grid-cols-2 gap-32 items-center">
            <div className="space-y-12">
              ...
              <div className="space-y-8 text-xl text-white/40 font-light leading-relaxed">
                <p>For months, we deployed capital and refined our engineering in total silence. We built a local ecosystem designed to return power to the Northwest Indiana merchant.</p>
                ...
                <p>Starting Monday, January 5th, we are opening the window for local leaders to anchor their stake.</p>
              </div>
            </div>
      ...
      <section className="py-40 bg-[#060D1A] text-center border-y border-white/[0.03]">
        <div className="max-w-4xl mx-auto px-10 space-y-12">
          ...
          <p className="text-[10px] uppercase tracking-[0.5em] font-black text-[#C83803]/50 italic text-center">Stewardship Window: Jan 5 - Jan 12</p>
        </div>
      </section>
      ...
      <section className="py-40 text-center relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-10 relative z-10">
          ...
          <p className="text-[#C83803] text-[10px] uppercase tracking-[0.6em] font-black italic mb-12">Final Deadline: Monday January 12th</p>
